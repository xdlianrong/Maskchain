...
int main() {
  ...
  const FieldT g = bigint_r("3545436565765768787879879898980990");//生成元
  const FieldT Gsk = bigint_r("123456789656565765767676767676767676");//私钥
  ...
  ************************************************/
  ...
  //明文m
  FieldT m = bigint_r("111111111111123");
