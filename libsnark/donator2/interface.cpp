...
typedef struct transferOne{
     ...
     r1cs_ppzksnark_verification_key<ppT> vk;/*验证密钥*/
     uint256 c_rt;/*承诺树根*/
      uint256 s_rt;/*发送方公钥树根*/
      uint256 r_rt;/*接收方公钥树根*/
    }tr;
template<typename FieldT>
...
msgMint makeMsgMint(uint256 kmint/*承诺*/,int64_t v/*金额*/,uint256 upk/*用户公钥*/)
{
   ...
   tmp2.Sigpub= EncodeRSAKeyFile( "rsa_public_key.pem"/*公钥文件*/, k );//基于openssl库的公钥加密，用私钥解密。
...
template<typename FieldT>
transferZero makeTransferZero(uint256 Rpk/*接收方公钥*/,uint256 pr1/*新随机数1*/,uint256 pr2/*新随机数2*/,uint64_t vr,uint256 Ssk/*发送发私钥*/,uint256 ps/*老随机数*/,uint64_t vs)
{ 
...
template<typename FieldT>
bool transferZeroVerify(uint256 SNold/*老序列号*/ ,uint256 krnew/*接受方新承诺*/,uint256 ksnew/*发送方新承诺*/,  unsigned char *data/*加密数据*/, r1cs_ppzksnark_proof<ppT> pr/*证明*/,r1cs_ppzksnark_verification_key<ppT> vk/*验证密钥*/,uint256 cm_rt/*老承诺树根*/,uint256 apk_s_rt/*发送方公钥树根*/,uint256 apk_r_rt/*接收方公钥树根*/)
{ 
...
template<typename FieldT>
bool transferOneVerify(uint256 SNold/*老序列号*/,uint256 krnew/*承诺*/, uint256 cm_rt/*承诺树根*/,uint256 apk_s_rt/*发送方公钥树根*/,uint256 apk_r_rt/*接收方公钥树根*/,unsigned char *data/*加密数据*/,r1cs_ppzksnark_verification_key<ppT> vk/*验证密钥*/, r1cs_ppzksnark_proof<ppT> pr/*证明*/)
{     
    std::vector<FieldT> pi_v;    
